...
export function LandingCta() {
  return (
    <section className="landing-haze border-b border-border px-6 py-20 text-center md:px-12 md:py-24">
      <h2 className="mx-auto max-w-[940px] text-[42px] font-bold leading-[1.12] text-text-slate md:text-[56px]">
        Your next job search can feel a lot less overwhelming
      </h2>
      <p className="mx-auto mt-6 max-w-[760px] text-base font-normal leading-7 text-text-slate-medium md:text-lg">
